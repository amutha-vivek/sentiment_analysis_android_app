...
public class signUp extends AppCompatActivity {
    private Button next;
    private EditText email, password, confirm_pass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirm_pass = findViewById(R.id.signup_confpass);
        next = findViewById(R.id.signup_exit);
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    AsyncTask<String, Void, String> result = new SendKeyword().execute("https://immense-hamlet-81042.herokuapp.com/signup", postData.toString());
